    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <motion.a
            href="https://dexscreener.com/solana/4hrp1p1szfgdiyankj8dyvbxbdjpe7hylyvj7n3hff7m"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="electric-button px-8 py-3 bg-gradient-to-r from-yellow-500 to-yellow-300 rounded-full text-black font-semibold transition-all flex items-center justify-center"
          >
          ...
          <motion.a
            href="https://halotech1.com/"
            target="_blank"
            rel="noopener noreferrer"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="electric-button px-8 py-3 bg-green-600 hover:bg-green-700 rounded-full text-white font-semibold transition-all flex items-center justify-center"
          >
            View Halotech LLC!
          </motion.a>
        </div>
